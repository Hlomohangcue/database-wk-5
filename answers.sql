...
-- First, create the IdxPhone index (assuming there's a phone column)
-- You can check your table structure with: DESCRIBE customers;
CREATE INDEX IdxPhone ON customers(phone);

-- Now drop the index as requested
